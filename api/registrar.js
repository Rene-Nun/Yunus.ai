...
"Entidad": { rich_text: [{ text: { content: Entidad_federativa || "" } }] },
"CP": { rich_text: [{ text: { content: Codigo_postal || "" } }] },
"Ingreso": { number: parseInt(Ingreso_mensual) || 0 },
"Celular_marca": { rich_text: [{ text: { content: Marca_celular || "" } }] },
"Gasto_celular": { rich_text: [{ text: { content: Gastos_celular || "" } }] },
"Gasto_vivienda": { rich_text: [{ text: { content: Gastos_vivienda || "" } }] },
"Gasto_auto": { rich_text: [{ text: { content: Gastos_automovil || "" } }] },
"Dependientes": { rich_text: [{ text: { content: Dependientes || "0" } }] },
"Historial": { rich_text: [{ text: { content: Historial_crediticio || "" } }] },
"Otras_deudas": { rich_text: [{ text: { content: Otras_deudas || "" } }] },
"Etapa": { rich_text: [{ text: { content: "bienvenida" } }] },
"Historial_chat": { rich_text: [] }
}
});
